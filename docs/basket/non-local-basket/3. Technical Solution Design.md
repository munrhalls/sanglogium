...
- [ ] check if every product has stock and reservedStock field
- [ ] make new GROQ to get only the required fields based on basket product ids (price_data, stock, reserved stock) 

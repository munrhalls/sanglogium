...
- BasketControls: render, add/increment/decrement/remove dispatch
...
## Test Order
Slice 1 (Data Layer) → Slice 2 (BasketControls) → Slice 3 (BasketButton) → Slice 4-6 (Page Integrations) → Slice 7 (Cross-Tab Sync) → E2E

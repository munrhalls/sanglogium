...
- BasketControls: render for both contexts (isBasketPage={false} and isBasketPage={true}), add/increment/decrement/remove dispatch
- BasketButton: render, badge count display, navigation
- Page integrations: Product Detail, Product Grid, Search with BasketControls

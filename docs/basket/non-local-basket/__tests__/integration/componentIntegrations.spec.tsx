...
describe('Basket Controls Integration Across App', () => {
  ...
  describe('Navigation Components', () => {
    describe('BasketButton', () => {
      it('displays badge with correct count from non-local basket store', () => {
  ...
  describe('Home Page Product Cards', () => {
    ...
    describe('FeaturedCard', () => {
      ...
      describe('when product in basket', () => {
        beforeEach(() => {
          useBasketStore.setState({
            items: [{ productId: mockFeaturedProduct._id, quantity: 1, displayPriceAtAdd: 100, availableStockAtAdd: 10 }],
          })
        })
    ...
    describe('IemCard', () => {
      ...
      describe('when product in basket', () => {
        beforeEach(() => {
          useBasketStore.setState({
            items: [{ productId: mockIemProduct._id, quantity: 1, displayPriceAtAdd: 100, availableStockAtAdd: 10 }],
          })
        })
    ...
    describe('AccessoryCard', () => {
      ...
      describe('when product in basket', () => {
        beforeEach(() => {
          useBasketStore.setState({
            items: [{ productId: mockAccessoryProduct._id, quantity: 1, displayPriceAtAdd: 100, availableStockAtAdd: 10 }],
          })
        })
  ...
  describe('Category Page Product Grid', () => {
    ...
    describe('ProductCard', () => {
      ...
      describe('when product in basket', () => {
        beforeEach(() => {
          useBasketStore.setState({
            items: [{ productId: mockProduct._id, quantity: 1, displayPriceAtAdd: 100, availableStockAtAdd: 10 }],
          })
        })
  ...
  describe('Basket Page', () => {
    ...
    describe('BasketControls on basket page', () => {
      describe('when product in basket', () => {
        beforeEach(() => {
          useBasketStore.setState({
            items: [{ productId: mockProductId, quantity: 1, displayPriceAtAdd: 100, availableStockAtAdd: 10 }],
          })
        })

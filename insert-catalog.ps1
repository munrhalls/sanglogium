...
try {
    ...
    Write-Host "`n📋 Catalog Structure Preview:" -ForegroundColor Cyan
    ...
    Write-Host "`n⚠️  To complete insertion:" -ForegroundColor Yellow
    ...
    Write-Host "`n✅ Catalog insertion preparation completed successfully!" -ForegroundColor Green

...
function productValues(product: HeadphoneProduct, facet: FacetDef): string[] {
...
export function filterProducts(products: HeadphoneProduct[], state: FilterSortState): HeadphoneProduct[] {
...
export function computeBooleanCounts(products: HeadphoneProduct[], state: FilterSortState): Record<string, number> {
...
export function derivedBrandLabels(products: HeadphoneProduct[]): Record<string, string> {

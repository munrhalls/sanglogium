...
import { FaTag, FaBoxOpen, FaPlug, FaChair, FaBolt, FaSprayCanSparkles, FaScrewdriverWrench, FaShuffle, FaVolumeHigh } from 'react-icons/fa6';
...
// this route's layout.tsx), and `scrollIntoView` walks up EVERY scrollable

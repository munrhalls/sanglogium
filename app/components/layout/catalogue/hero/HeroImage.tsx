...
export default function HeroImage({ data }: { data: CatalogueItem }) {
  return (
    <div
      className={cn(
        "absolute top-8 h-96 w-96 text-accent-600 opacity-40",
        ...
        "lg-desktop:landscape:aspect-square lg-desktop:landscape:h-[87.5%] lg-desktop:landscape:w-auto",
        "lg-desktop:landscape:left-[-32.5%]"
      )}
    >
      <Image
        src={data.imageUrl}

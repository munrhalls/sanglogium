...
export function CatalogueMenu({
  ...
  return (
    <div className="relative flex h-auto sm:h-full w-full flex-1 flex-col items-start justify-start gap-8 bg-brand-700 pb-12 landscape:h-full landscape:pb-0 landscape:flex-row">

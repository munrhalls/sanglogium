...
export default function IemCard({ iem }: IemCardProps) {
  return (
    <div className="group bg-brand-800/10 border border-brand-800/20 p-5 rounded-sm hover:border-brand-400/50 transition-all duration-500">

            ...
            >
              <div className="bg-brand-800/10 border border-brand-800/20 p-4 group transition-all duration-500 hover:border-brand-400/40">
                <div className="h-32 w-full flex items-center justify-center p-2 mb-4 bg-black/20">
                  <div className="relative w-full h-full"><Image src={item.imageUrl} alt={item.name} fill className="max-h-full max-w-full object-contain group-hover:scale-110 transition-transform duration-700" sizes="(max-width: 768px) 100vw, 33vw" /></div>
                </div>

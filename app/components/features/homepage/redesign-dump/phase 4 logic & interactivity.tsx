                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <article className="group flex flex-col gap-4 p-6 border border-secondary-800 rounded-lg bg-transparent transition-all duration-300 hover:border-secondary-600 hover:bg-secondary-900/10">
                        <div className="aspect-square w-full bg-brand-800/50 rounded-md overflow-hidden relative flex items-center justify-center p-8">
                            <img
                                src="https://cdn.sanity.io/images/2tdmkpky/production/42f23254360ef257b21f5dabf676fd5d99d9eae7-1200x1200.jpg"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    <div className="w-full flex justify-center lg:justify-start">
                        <div className="relative w-full max-w-[450px] aspect-square flex items-center justify-center">
                            <div className="absolute inset-0 bg-accent-500/5 blur-[100px] rounded-full"></div>
                            <img
                                src="https://cdn.sanity.io/images/2tdmkpky/production/548a9c2b395dff17024bad8d3c62d8f3f33bf849-1024x1024.jpg"
                                alt="Meze Audio LIRIC II"

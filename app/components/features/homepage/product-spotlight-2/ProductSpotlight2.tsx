        ...
        <article className="w-full relative overflow-hidden bg-brand-800">
            <div className="max-w-content mx-auto relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-8 lg:gap-20 items-stretch">
                    <div className="order-2 w-full aspect-square md:aspect-[4/3] lg:aspect-[3/2] lg-touch:aspect-[16/9] bg-surface-productImage rounded-none flex items-center justify-center relative overflow-hidden border border-border-secondary">
                    ...
                    <div className="order-1 w-full h-full bg-surface-subtle rounded-none flex flex-col justify-center p-8 lg:p-12 lg-touch:p-6 relative overflow-hidden border border-border-secondary shadow-cardDark">

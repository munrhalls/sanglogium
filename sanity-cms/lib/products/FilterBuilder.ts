 ...
 * Restored (query logic only, no old coupling) from
 * product-building-center/filters_archived/sanity-cms/lib/products/FilterBuilder.ts
 * for the Product Grid + Server tracer bullet ("read URL -> ask the Server").
 */

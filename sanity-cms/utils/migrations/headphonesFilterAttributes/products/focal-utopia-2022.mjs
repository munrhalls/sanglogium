...
// (product 8) for the full per-field table and citation trails this was
// transcribed from.
//
// Duplicate-record note: this Sanity doc ("Utopia 2022") and
// moXlkADK7m1DHgGwWtUHWs ("Utopia") are the same Focal SKU at the same
// $4,999 price, mapped from Focal's single current Utopia page/manual. Both
// are sourced identically rather than inventing a second spec set. Flagged for
// a catalogue de-duplication pass — not resolved here, since this issue's
// product list must match its 8 enumerated _ids exactly.

export default {
  productId: "PHPYj28HJdPDHAaIBADqsm",
  brand: "Focal",
  name: "Utopia 2022",
  beadsIssue: "sang-logium-1xs.9.5.8",
  ...
  sourcing: [
    ...
    },
    {
      ...
      url: "https://www.focal.com/products/utopia",
      quote: "Frequency response (+/- 3dB) : 5 Hz – 23 kHz (live page kept over manual's \"5Hz - 50kHz\" per the manufacturer self-contradiction rule)",
      tier: "hard-spec",
      sourcedAt: "2026-09-13",
    },
    {

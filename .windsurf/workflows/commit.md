...
3. **Orient & Group:** Explicitly outline how the unstaged/untracked files group into logical, atomic units based on recent work. Map these groupings to the required taxonomy categories (A, B, C, D, E) below.
...
4. **NO MIXED CONCERNS:** Do not mix files belonging to different taxonomy categories in the same commit.

## 🗂️ Phase 3: Required Taxonomy & Formatting
Every commit message MUST adhere to the following taxonomy and template structure.

**Fibonacci Difficulty Scale:** 1, 2, 3, 5, 8, 13

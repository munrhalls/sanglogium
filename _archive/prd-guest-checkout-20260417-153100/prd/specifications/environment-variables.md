...
GUEST_CHECKOUT_REDIS_KEY_PREFIX=dev:  # Use test: for tests, prod: for production
...
GUEST_CHECKOUT_REDIS_KEY_PREFIX=dev:
...
const envSchema = Joi.object({
  ...
  GUEST_CHECKOUT_REDIS_KEY_PREFIX: Joi.string().optional(),
...
```bash
# Use .env.local for testing - single Redis instance

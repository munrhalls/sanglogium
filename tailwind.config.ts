...
const uiComponentsPlugin = plugin(function ({ addComponents, theme }) {
  addComponents({
    ...
    ".input-select": {
      ...
      color: theme("colors.text.body") as string,
      appearance: "none",
      backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%23${(theme("colors.text.body") as string).slice(1)}' stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M6 8l4 4 4-4'/%3e%3c/svg%3e")`,

...
- `/retrieve-lessons` — Load relevant lessons before work
- `/sprint` — Sprint planning with post-sprint /learn trigger

**Related Files:**
- `_handbook/03-commands/learn.md` — Full command reference

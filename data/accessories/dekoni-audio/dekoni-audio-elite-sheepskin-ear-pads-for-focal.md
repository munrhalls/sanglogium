...
spec_fields: 
  ...
  compatibility: 
    - "Dekoni Audio Elite Sheepskin Ear Pads for Focal"
...
- **compatibility**: ["Dekoni Audio Elite Sheepskin Ear Pads for Focal"] — compatible models extracted from the manufacturer product page and product title.

...
spec_fields: 
  ...
  compatibility: 
    - "audiophiles using Focal models like Clear"
    - "Elex"
    - "Stellia"
    - "Utopia"
...
- **compatibility**: ["audiophiles using Focal models like Clear","Elex","Stellia","Utopia"] — compatible models extracted from the manufacturer product page and product title.

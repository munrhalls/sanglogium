// Detect broken (placeholder) main images on the audio-electronics category page.
// Same logic as check-accessories-broken-images-final.mjs but targeting
// http://localhost:3000/products/audio-electronics
...
// Save full analysis
fs.writeFileSync(
  "audio-electronics-image-analysis.json",
  JSON.stringify(
    {

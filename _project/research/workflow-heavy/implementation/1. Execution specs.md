...
Before writing execution spects, write entries in ExecutionSpecs.todo in the /docs/<feature name>/implementation/ExecutionSpecs.todo; file should already exist - if not, make it. Keep track of written execution specs in professional manner.
